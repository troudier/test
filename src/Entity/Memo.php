...
class Memo
{
     ...
     * @ORM\Column(name="mem_uuid", type="uuid", unique=true)
    ...
    /**
     * @Groups({"read", "write"})
     * @ORM\Column(name="mem_texte", type="text")
     */
    private $texte;

    /**
     * @Groups({"read", "write"})
     * @ORM\ManyToOne(targetEntity="App\Entity\PersonneLien", inversedBy="memos")
     */
    private $lien;

    /**
     * @Groups({"read", "write"})
     * @ORM\Column(name="mem_crea_date", type="datetime")
     */
    private $dateCreation;

    /**
     * @Groups({"read", "write"})
     * @ORM\Column(name="mem_modif_date", type="datetime")
     */
