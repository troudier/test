...
class Mail
{
     ...
     * @ORM\Column(name="mail_uuid", type="uuid", unique=true)
    ...
    /**
     * @Groups({"read", "write"})
     * @ORM\Column(name="mail_valeur", type="string", length=255)
     */
    private $valeur;

    /**
     * @Groups({"read", "write"})
     * @ORM\OneToMany(targetEntity="App\Entity\LienMail", mappedBy="mail")
     */
    private $liens;

    /**
     * @Groups({"read", "write"})
     * @ORM\Column(name="mail_crea_date", type="datetime")
     */
    private $dateCreation;

    /**
     * @Groups({"read", "write"})
     * @ORM\Column(name="mail_modif_date", type="datetime")
     */
