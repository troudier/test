...
class Organisation
{
     ...
     * @ORM\Column(name="org_uuid", type="uuid", unique=true)
    ...
    /**
     * @Groups({"read", "write"})
     * @ORM\Column(name="org_nom", type="string", length=255, unique=true)
     */
    private $nom;

    /**
     * @Groups({"read", "write"})
     * @ORM\Column(name="org_db_id", type="string", length=255)
     */
    private $dbId;

    /**
     * @Groups({"read", "write"})
     * @ORM\Column(name="org_crea_date", type="datetime")
     */
    private $dateCreation;

    /**
     * @Groups({"read", "write"})
     * @ORM\Column(name="org_modif_date", type="datetime")
     */
