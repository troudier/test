...
class Tag
{
     ...
     * @ORM\Column(name="tag_uuid", type="uuid", unique=true)
    ...
    /**
     * @Groups({"read", "write"})
     * @ORM\Column(name="tag_libelle", type="string", length=45)
     */
    private $libelle;

    /**
     * @Groups({"read", "write"})
     * @ORM\Column(name="tag_systeme", type="smallint", length=1)
     */
    private $systeme;

    /**
     * @Groups({"read", "write"})
     * @ORM\Column(name="tag_target", type="integer")
     */
    private $target;

    /**
     * @Groups({"read", "write"})
     * @ORM\Column(name="tag_crea_date", type="datetime")
     */
    private $dateCreation;

    /**
     * @Groups({"read", "write"})
     * @ORM\Column(name="tag_modif_date", type="datetime")
     */
